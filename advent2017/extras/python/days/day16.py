...
def parse_moves(raw: str) -> list[str]:
    """
    Run `parse_moves` as a clearly documented algorithm stage.
...
def apply_once(state: list[str], moves: list[str]) -> None:
    """
    Run `apply_once` as a clearly documented algorithm stage.
