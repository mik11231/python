#!/usr/bin/env python3
"""Advent of Code 2023 Day 17 Part 2 - Clumsy Crucible.

Ultra crucibles must move a minimum of 4 and maximum of 10 blocks straight
before turning.  Same Dijkstra approach with adjusted constraints.
"""
...
def solve(s: str) -> int:
    ...
    while pq:
        ...
        if r == rows - 1 and c == cols - 1 and consec >= 4:
            return cost
